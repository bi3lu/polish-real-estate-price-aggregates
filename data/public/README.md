...
| File | Description |
| --- | --- |
| `estate_public_ml_features_20260521T121529135028Z.csv` | Public listing-level feature table for analysis and ML experiments. |
| `estate_public_data_quality_20260521T121529135028Z.csv` | Dataset-level quality and coverage metrics for the same export run. |
...
snapshot contains 53,022 public records from selected voivodeships only:
...
| Metric | Value |
| --- | ---: |
| `source_records_count` | 53,022 |
| `public_records_count` | 53,022 |
| `min_group_size` | 10 |
| `share_with_public_city` | 0.7619 |
| `share_with_public_geo_grid` | 0.1212 |
| `share_with_public_price_target` | 0.9896 |
| `distinct_public_cities_count` | 442 |
...
The public dataset may be used for private projects, research, education,
analysis, dashboards, experiments, and other non-identifying analytical work.
Redistribution or publication of derived work is allowed provided that attribution
is preserved.

Required attribution:

Public Anonymized Polish Real Estate Dataset by
[Jakub Bielecki](https://github.com/bi3lu).

When citing the dataset in a report, notebook, presentation, or repository,
include the attribution above and a link to this repository when available.

The dataset must not be used to identify, re-identify, contact, profile, or
target individual sellers, properties, or source listings.
